...
header(2)
message("OLS is not an appropriate estimator in this case, as the assumption of exogeneity is violated")
message("We see this in the construction of x_3, as it is explicitly correlated with the error term.")
message("Because of this, errors will increase with larger values of x_3, and is likely to give biased, insistant estimates")
header(3)
